...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, FND_RCLK_Pin|RELAY_CTRL_Pin|BUTTON_LED_Pin|START_LED_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : UP_BUTTON_Pin SET_BUTTON_Pin DOWN_BUTTON_Pin */
  GPIO_InitStruct.Pin = UP_BUTTON_Pin|SET_BUTTON_Pin|DOWN_BUTTON_Pin;
  ...
  /*Configure GPIO pins : FND_RCLK_Pin RELAY_CTRL_Pin BUTTON_LED_Pin START_LED_Pin */
  GPIO_InitStruct.Pin = FND_RCLK_Pin|RELAY_CTRL_Pin|BUTTON_LED_Pin|START_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
